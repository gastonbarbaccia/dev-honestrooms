...
Route::get('admin_approve','EmailController@approve_email_admin');
Route::get('become_a_host','RoomsController@become_a_host');
...
Route::group(
	...
	function () {
		...
		Route::get(
			'account',
			function () {
				return Redirect::to('users/transaction_history');
			}
		);
		Route::get('rooms', 'RoomsController@index');
		Route::get('rooms/new', 'RoomsController@new_room');
		Route::post('rooms/create', 'RoomsController@create');
		Route::post('rooms_available_date','RoomsController@rooms_available_date');
		Route::get(
			'rooms/create',
			function () {
		...
		Route::group(
			...
			function () {
				...
				//Service , host , rules update ,changes to 11/02/2019
				Route::post('manage-listing/{id}/update_services_offer', 'RoomsController@update_services_offer')->where('id', '[0-9]+');
				Route::post('manage-listing/{id}/update_lives_house', 'RoomsController@update_lives_house')->where('id', '[0-9]+');
				Route::post('manage-listing/{id}/update_speak_language', 'RoomsController@update_speak_language')->where('id', '[0-9]+');
				Route::post('manage-listing/{id}/update_pets', 'RoomsController@update_pets')->where('id', '[0-9]+');
				Route::post('manage-listing/{id}/update_service', 'RoomsController@update_service')->where('id', '[0-9]+');
		...
		Route::get('manage-listing/{id}/{page}', 'RoomsController@manage_listing')
			->where(['id' => '[0-9]+', 'page' => 'basics|description|location|amenities|photos|video|pricing|calendar|details|guidebook|terms|booking|services|host|rules|bathrooms|completed']);
		Route::post('ajax-manage-listing/{id}/{page}', 'RoomsController@ajax_manage_listing')
			->where(['id' => '[0-9]+', 'page' => 'basics|description|location|amenities|photos|video|pricing|calendar|details|guidebook|terms|booking|services|host|rules|bathrooms']);
		...
		Route::get('messaging/admin/{id}', 'InboxController@admin_message')->where('id', '[0-9]+');
