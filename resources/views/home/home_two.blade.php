        ...
        <div class="whole-section sect_home" ng-controller="home_owl" ng-cloak>
            ...
            HostExperienceBladeCommentEnd --}}
                    ...
                    <div class="discovery-tiles">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3" style="float:left;text-align:center">
                                ...
                                <div style="padding-left:5%;padding-right:5%">
                                    <p class="content-font" style="margin-left: 5%;margin-right: 5%;font-size:16px">
                                        ...
                                        confirmar la solicitud. Podran hablar a través de nuestra plataforma para despejar
                                        dudas.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3" style="float:left;text-align:center">
                                ...
                                <div>
                                    <h4 style="color: #24A4BA; font-weight: 700;font-size: 140%;">Todo listo para mudarte
                                    </h4>
                                </div>
                                <div style="padding-left:5%;padding-right:5%">
                                    <p class="content-font" style="margin-left: 5%;margin-right: 5%;font-size:16px">
                                        ¡Llegó el dia! Ya tenes un nuevo hogar y llegaste al comienzo de tu estadía en esta
                                        hermosa ciudad. Te recibirá tu anfitrión y realizarán la firma online del contrato.
                                    </p>
                                </div>
                            </div>
                ...
                <div style="text-align:center;margin-top:4%;font-size:20px;margin-bottom:8%">
                    <a href="how_it_works" style="color:#24A4BA;text-decoration: none;" target="_blank">QUIERO SABER MÁS <i
