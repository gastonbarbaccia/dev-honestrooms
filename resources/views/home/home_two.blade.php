    ...
    <main>
        ...
        <div class="whole-section sect_home" ng-controller="home_owl" ng-cloak>
            <div class="page-container-responsive new-page-container mini-rel-top row-space-top-1">
                ...
                <div class="panel">
                    <div id="discovery-container" class="pad-sm-20 mt-5"
                        style="float:left;width:100%;/* height: 100% !important; background-image: url('http://honestrooms-qa.herokuapp.com/images/home/home_two_new.jpg') ;*/ height: 600px;width: 1500px;margin-left: -170px;padding-right: 100px; padding-left: 20%;background-repeat: no-repeat;">
                        <img src="http://honestrooms-qa.herokuapp.com/images/home/home_two_new.jpg" alt=""
                            class="my-5 mt-md-0"
                            style="position: absolute; left: 0; width: 100%; height: 600px; object-fit: cover;object-position: top;">
                            ...
                            <div class="no-mar-sm" style="margin-top: 94px;">
                                <div
                                    ...
                                    <h1 class="textHeader_8yxs9w" style="color:white !important;">
                                        ...
                                        <!-- react-text: 7341 -->
                                        <br>
                                        <div class="ggb-responsive" style="font-size:30px">
                                            {{ trans('messages.home.desc') }}
                                            <br>
                                            {{ trans('messages.home.desc_2') }}
                                        </div>
                                        <!-- /react-text -->
                                    </h1>
                                </div>
            ...
            HostExperienceBladeCommentEnd --}}
                <div class="discovery-section explore_community exploer_banner page-container-no-padding mt-0 mt-md-5"
                    ...
                    <div class="section-intro text-center row-space-6 row-space-top-8" ng-if="home_city_explore.length!=0">
                        <h2 class="row-space-1">
                             <strong>{{ trans('messages.home.how_it_works') }}</strong>
                        </h2>
                    ...
                    <div class="discovery-tiles">
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-3" style="float:left;text-align:center">
                                ...
                                <div>
                                    <h4 style="color: #24A4BA ; font-weight: 700;font-size: 140%;">
                ...
                <div style="text-align:center;margin-top:4%;font-size:20px;margin-bottom:8%">
                    <a href="how_it_works" style="color:#24A4BA;text-decoration: none;" target="_blank">
                        {{ trans('messages.home.know_more') }}
                         <i class="fa fa-angle-right" style="color:#24A4BA;padding-left:3px;"></i></a>
                </div>
                ...
                <div class="discovery-section explore_community exploer_banner page-container-no-padding"
                    ...
                    <div class="section-intro text-center row-space-6 row-space-top-8" ng-if="home_city_explore.length!=0">
                        <p class="text-lead">
                            {{ trans('messages.home.why_choose_us') }}
                        </p>
                        <h2 class="row-space-1">
                            {{ trans('messages.home.our_differential') }}
                        </h2>
                    </div>
                    ...
                    <div class="row d-flex justify-content-around">
                        ...
                        <div class="discovery-tiles col-sm-12 col-md-6 px-3 px-md-2" id="eye">
                            ...
                            <div class=" mb-5 bg-white rounded p-3">
                                ...
                                <div style="margin-top:7%;font-weight: bold">
                                    <h4>
                                        {{ trans('messages.home.differential_1_title') }}
                                    </h4>
                                </div>
                                <div>
                                    <p class="content-font">
                                        {{ trans('messages.home.differential_1_desc') }}
                                    </p>
                                </div>
                        ...
                        <div class="discovery-tiles col-sm-12 col-md-6 px-3 px-md-2" id="check">
                            ...
                            <div class=" mb-5 bg-white rounded p-3">
                                ...
                                <div style="margin-top:7%;font-weight: bold">
                                    <h4>
                                        {{ trans('messages.home.differential_2_title') }}
                                    </h4>
                                </div>
                                <div>
                                    <p class="content-font">
                                        {{ trans('messages.home.differential_2_desc') }}
                                    </p>
                                </div>
                        ...
                        <div class="discovery-tiles col-sm-12 col-md-6 px-3 px-md-2" id="heart" style="margin-top:2%">
                            ...
                            <div class=" mb-5 bg-white rounded p-3">
                                ...
                                <div style="margin-top:7%;font-weight: bold">
                                    <h4>
                                         {{ trans('messages.home.differential_3_title') }}
                                    </h4>
                                </div>
                                <div>
                                    <p class="content-font">
                                        {{ trans('messages.home.differential_3_desc') }}
                                    </p>
                                </div>
                        ...
                        <div class="discovery-tiles col-sm-12 col-md-6 px-3 px-md-2" id="people" style="margin-top:2%">
                            ...
                            <div class=" mb-5 bg-white rounded p-3">
                                ...
                                <div style="margin-top:7%;font-weight: bold">
                                    <h4>
                                        {{ trans('messages.home.differential_4_title') }}
                                    </h4>
                                </div>
                                <div>
                                    <p class="content-font">
                                        {{ trans('messages.home.differential_4_desc') }}
                                    </p>
                                </div>
            ...
            <div id="discovery-container " class="pad-sm-20 fondoGris" style="margin-top:5%">
                ...
                <div class="discovery-section explore_community exploer_banner page-container-no-padding"
                    ...
                    <div class="text-center row-space-6 row-space-top-8">
                        <p class="text-lead">
                            {{ trans('messages.home.testimonials') }}
                        </p>
                        <h2 class="row-space-1">
                            {{ trans('messages.home.testimonials_clients') }}
                        </h2>
                    </div>
                ...
                <div id="discovery-container" class="pad-sm-20">
                    ...
                    <div class="discovery-section explore_community exploer_banner page-container-no-padding"
                        ...
                        <div class="section-intro text-center row-space-6 row-space-top-8">
                            <p class="text-lead">
                                {{ trans('messages.home.press') }}
                            </p>
                            <h2 class="row-space-1">
                                {{ trans('messages.home.what_the_media_say') }}
                            </h2>
                        </div>
                            ...
                            <div class="discovery-tiles col-12 col-lg-4">
                                ...
                                <div class="shadow-sm p-3 mb-5 bg-white rounded" style="border: #EDEDED 3px solid;">
                                    ...
                                    <a class="btn btn-outline-primary w-50" href="#"
                                        style="border-color: #24A4BA;color: #24A4BA;border-radius: 0.5em;"> {{ trans('messages.home.read_more') }}</a>
