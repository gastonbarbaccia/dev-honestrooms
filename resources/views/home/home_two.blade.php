        ...
        <div class="page-container-responsive new-page-container mini-rel-top row-space-top-1">
            <div class="panel">
                <div id="discovery-container" class="pad-sm-20"
                    style="float:left;width:100%;/* height: 100% !important; */background-image: url('http://honestrooms.herokuapp.com/images/home/home_two_new.jpg');height: 600px;width: 1500px;position: relative;margin-left: -170px;padding-right: 100px; padding-left: 20%;background-repeat: no-repeat;">
            ...
            <div class="lazy-load-div1 lazy-load1 col-md-12 col-lg-12 col-sm-12 col-xs-12  p-0" id="lazy_load_slider">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="reservation.length > 0">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 newsl"
                        ...
                        <h3 class="rowHeader pull-left"> react-text: 38121 {{ trans('messages.header.justbooked') }}
                            /react-text </h3>
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="recommented.length >0">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 newsl "
                        style="padding:0px;     margin: 45px 0px 15px;">
                        <h3 class="rowHeader pull-left"> react-text: 38121 {{ trans('messages.header.recommend') }}
                            /react-text </h3>
                        <div class="seeMoreContainer_11b8zgn pull-right">
                ...
                <!--/react-text</h3>
                                 <!--   <div class="seeMoreContainer_11b8zgn pull-right">
                                        ...
                                        <a href="{{ url('s') }}" ng-if="most_viewed.length > 3">
                                            <button class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">
                                                <span
                                                    class="text_13lu1ne"><span>{{ trans('messages.header.seeall') }}</span>
                                                </span>
                ...
                <div class="discovery-section explore_community exploer_banner page-container-no-padding"
                    id="discover-recommendations" ng-init="city_count=city_count-1 ;" style="background-color:#E7E5E5">
                    <div class="section-intro text-center row-space-6 row-space-top-8"
                        ng-if="home_city_explore.length!=0">
                        <p class="text-lead">
                            TESTIMONIOS
                        ...
                        <div class="columnContentContainer">
                            ...
                            <div class="textContainer">
                                ...
                                <div><span class="content-font">If you need help while traveling or hosting, contact us
                                        at our toll free number: {{$customer_support}}</span></div>
                            </div>
                        </div>
                    </div>
