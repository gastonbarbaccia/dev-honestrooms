    ...
    <div class="whole-section sect_home" ng-controller="home_owl" ng-cloak>
        <div class="page-container-responsive new-page-container mini-rel-top row-space-top-1">
            ...
            <div class="panel">
                ...
                <img src="http://honestrooms-qa.herokuapp.com/images/home/banner.jpg" alt="" class="my-5 mt-md-0" style="position: absolute; left: 0; width: 100%; height: 400px; object-fit: cover;margin-top: -100px !important;">
