<div id="header"
    class="makent-header {{ (!isset($exception)) ? (Route::current()->uri() == '/' ? 'shift-with-hiw' : '') : '' }}">
    <header class="header--sm show-sm" aria-hidden="true" role="banner">
        <a href="javascript:void(0);" href="{{ url('/') }}" aria-label="Homepage" data-prevent-default=""
            class="header-logo link-reset burger--sm">
            <img src="http://honestrooms.herokuapp.com/images/logos/logo.png" style="height: 100%;padding-left: 20%;">
        ...
        <nav role="navigation" class="nav--sm">
            ...
            <div class="nav-content--sm panel text-white">
                ...
                <div class="nav-header {{ (Auth::user()) ? '' : 'items-logged-in' }}">
                    <div class="nav-profile clearfix">
                        <div class="user-item pull-left">
                            <a href="{{ url('/') }}/users/show/{{ (Auth::user()) ? Auth::user()->id : '0' }}"
                                class="link-reset user-profile-link">
                                <div class="media-photo media-round user-profile-image"
                                    style="background:rgba(0, 0, 0, 0) url({{ (Auth::user()) ? Auth::user()->profile_picture->header_src : '' }}) no-repeat scroll 0 0 / cover">
                                </div>
               ...
               <li class="{{ (Auth::user()) ? 'items-logged-out' : '' }}">
                                ...
                                <li class="{{ (Auth::user()) ? 'items-logged-out' : '' }}">
                                    <a rel="nofollow" class="link-reset menu-item " href="{{ url('/') }}/signup_login"
                                        data-signup-modal="">
                                        {{ trans('messages.header.signup') }}
                                    </a>
                                </li>
                                <li class="{{ (Auth::user()) ? 'items-logged-out' : '' }}">
                                    <a rel="nofollow" class="link-reset menu-item " href="{{ url('/') }}/login"
                                        data-login-modal="">
                                        {{ trans('messages.header.login') }}
                                    </a>
                                </li>
                                <li class="{{ (Auth::user()) ? 'items-logged-out' : '' }}" aria-hidden="true">
                                    <hr class="divider_1qenmrf">
                                </li>

                                <li class="{{ (Auth::user()) ? '' : 'items-logged-in' }}">
                                    <a href="{{ url('dashboard') }}" rel="nofollow"
             ...
             padding: 10px;"><svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                                            style="display: block; fill: currentcolor; height: 26px; width: 26px;">
                                            <path fill-rule="evenodd"></path>
                                        </svg></div>
                                </li>
                                <li class="{{ (Auth::user()) ? '' : 'items-logged-in' }}">
                                    <a href="{{ url('users/edit') }}" rel="nofollow"
                                        class="no-crawl link-reset menu-item item-user-edit">
           ...
           padding: 10px;"><svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                                ...
                                <li class="{{ (Auth::user()) ? '' : 'items-logged-in' }}">
                                    <a href="{{ url('account') }}" rel="nofollow"
                                        class="no-crawl link-reset menu-item item-user-edit">
      ...
      padding: 10px;"><svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                                ...
                                <li class="{{ (Auth::user()) ? '' : 'items-logged-in' }}">
                                    ...
                                    <div class="child_1g2dfiu-o_O-child_alignMiddle_13gjrqj" style="float: right;
      padding: 10px;"><svg viewBox="0 0 32 32" fill="currentColor" fill-opacity="0" stroke="currentColor"
                                            stroke-width="1.5" aria-hidden="true" role="presentation"
      ...
      <a href="{{ url('disputes') }}" class="link-reset menu-item">{{ trans('messages.disputes.disputes') }}
                                ...
                                <li class="{{ (Auth::user()) ? '' : 'items-logged-in' }}" aria-hidden="true">
                                    <hr class="divider_1qenmrf">
                                </li>
                                ...
                                {{--HostExperienceBladeCommentStart
   <li class="{{ (Auth::user()) ? '' : 'items-logged-in' }}">
                                <a rel="nofollow" href="{{ url('host/experiences') }}" rel="nofollow"
                                    class="no-crawl link-reset menu-item item-listing padding-left">
                                    {{ trans('messages.header.head_experience') }}
                                </a>
                                </li>
                                HostExperienceBladeCommentEnd--}}
                                ...
                                <li>
                                    <a rel="nofollow"
                                        class="link-reset menu-item js-show-how-it-works {{(!isset($exception)) ? (Route::current()->uri() == '/' ? '' : 'hide') : ''}}"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="panel-body">
                                <div class="modal-search-wrapper--sm">
                                    ...
                                    <div class="row">
                                        <div class="searchbar__location-error hide" style="left:22px; top:2%;">
                                            {{ trans('messages.home.search_validation') }}</div>
                                        <div class="col-sm-12">
                                            <label for="header-location--sm">
                                                <span
                                                    class="screen-reader-only">{{ trans('messages.header.where_are_you_going') }}</span>
                                                <input type="text"
                                                    placeholder="{{ trans('messages.header.where_are_you_going') }}"
                                                    autocomplete="off" name="location" id="header-search-form-mob"
                                                    class="input-large" value="{{ @$location }}">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row row-condensed">
                                        <div class="col-sm-6">
                                            <label class="checkin">
                                                <span
                                                    class="screen-reader-only">{{ trans('messages.home.checkin') }}</span>
                                                <input type="text" readonly="readonly" onfocus="this.blur()"
                                                    autocomplete="off" name="checkin" id="modal_checkin"
                                                    class="checkin input-large ui-datepicker-target"
                                        ...
                                        <div class="col-sm-6">
                                            <label class="checkout">
                                                <span
                                                    class="screen-reader-only">{{ trans('messages.home.checkout') }}</span>
                                                <input type="text" readonly="readonly" onfocus="this.blur()"
                                                    autocomplete="off" name="checkout" id="modal_checkout"
                                                    class="checkout input-large ui-datepicker-target"
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="select select-block select-large">
                                                <select id="modal_guests" name="guests--sm">
                                                    @for($i=1;$i<=$number_of_accomodates;$i++) <option value="{{ $i }}"
                                                        {{ ($i == @$guest) ? 'selected' : '' }}>{{ $i }}
                                                        {{ ($i>1) ? trans_choice('messages.home.guest',$i) : trans_choice('messages.home.guest',$i) }}
                                                        </option>
                                                        @endfor
                                                </select>
                                            </div>
                    ...
                    <div class="panel-new-headermenu-header normal-line-height">
                      <strong>{{ trans('messages.referrals.explore') }}</strong>
                                            <ul class="header_refinement_ul">
                                                <input type="hidden" name="header_refinement"
                                                    class="header_refinement_input" value="Homes">
                                                <li><button class="header_refinement active" data="Homes" type="button"
                                                        id="ftb">{{ trans('messages.header.homes') }}</button></li>
                                                <li><button class="header_refinement" data="Experiences" type="button"
                                                        id="ftb1">{{ trans_choice('messages.home.experience',1) }}</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                ...
                                                <div class="rom_ty" id="content-1">
                                                    ...
                                                    <div class="col-md-12 margin-top-10">
                                                        <div class="row">
                                                            <div class="holecheck">
                                                                <div class="">
                                                                    <input type="checkbox" value="{{ @$row_room->id }}"
                                                                        id="room-type-{{ @$row_room->id }}"
                                                                        class="mob_room_type" />
                                                                    @if($row_room->id == 1)
                                                                    ...
                                                                    @if($row_room->id >= 4)
                                                                    <i
                                                                        class="icon icon1-home-building-outline-symbol2 h5 needsclick"></i>
                                                                    @endif
                                                                    <label class="search_check_label"
                                                                        for="room-type-{{ @$row_room->id }}">{{ @$row_room->name }}</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="rom_ty" id="content-3">
                                            ...
                                            <div class="col-md-12 margin-top-10">
                                                <div class="row">
                                                    <div class="holecheck">
                                                        <div class="">
                                                            <input type="checkbox" id="cat-type-{{ @$row_cat->id }}"
                                                                value="{{ @$row_cat->id }}" class="mob_cat_type" />
                                                            <label class="search_check_label"
                                                                for="cat-type-{{ @$row_cat->id }}">{{ @$row_cat->name }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="pull-right resp-zoom">
        <ul class="nav pull-left help-menu list-unstyled">
            <li class="list-your-space pull-left">
                <a id="my_element" href="http://honestrooms.herokuapp.com/#"
                    style="border-left:none !important;color:#484848 !important">
...
<header class="regular-header clearfix hide-sm" id="old-header" role="banner" style="background: none !important;">
    ...
    <a aria-label="Homepage"
        style="background-image: url('http://honestrooms.herokuapp.com/images/logos/Logo_sparerooms.png'); position: absolute;height: 100px !important;width: 300px !important;margin-top: -30px;"
        href="{{ url('/') }}"
    ...
    <div class="pull-right resp-zoom">
      ...
      @if(!Auth::check())
      <li class="list-your-space pull-left">
        <a id="my_element"  class="header-become-host become {{ Auth::check() ? '' : 'login_popup_open' }}"
            href="javascript:void(0)" style="border-left:none !important;">
            ...
            <ul class="become_dropdown " style="display:none">
                <li>
                    <a href="{{ url('rooms/new') }}" rel="nofollow"
                        class="no-crawl link-reset menu-item item-dashboard padding-left">
                        {{ trans('messages.header.head_homes') }}
                    </a>
                </li>
                <li class="listings">
                    <a href="{{ url('host/experiences') }}" rel="nofollow"
                        class="no-crawl link-reset menu-item item-listing padding-left">
                        {{ trans('messages.header.head_experience') }}
                    </a>
                </li>
        ...
        <ul class="nav pull-left logged-out list-unstyled">
            <li id="sign_up" class="pull-left font-color">
                <a data-signup-modal="" data-header-view="true" href="{{ url('signup_login') }}" data-redirect=""
                    class="link-reset signup_popup_head ">
                    {{ trans('messages.header.signup') }}
                </a>
            </li>
        ...
        <i class="alert-count fade">0</i>
                ...
                <div class="panel drop-down-menu-trip hide js-become-a-host-dropdown">
                    <div class="trip-width">
                        <div class="panel-header no-border section-header-home"><strong><span>Trips</span></strong><a
                                href="{{ url('trips/current') }}"
                                class="link-reset view-trips pull-right"><strong><span>View Trips</span></strong></a>
                        </div>
                        ...
                        <div class="panel-header no-border section-header-home pull-left" style="width:100%;">
                            <strong><span>Wishlist</span></strong><a href="{{ url('wishlists/my') }}"
                                class="link-reset view-trips pull-right"><strong><span>View
                                        Wishlists</span></strong></a>
                        </div>
                        <div class="pull-left" style="width:100%;padding:15px 20px;">
                            <div class="pull-left" style="padding:15px 20px 0px;">
            ...
            <li id="inbox-item" class="inbox-item pull-left dropdown-trigger js-inbox-comp"
                ng-init="inbox_count='{{ @Auth::user()->inbox_count()}}'">
                <a href="{{ url('inbox') }}" rel="nofollow" class="no-crawl link-reset inbox-icon">
                    <span class="" style="position:relative;"> {{ trans_choice('messages.dashboard.message', 2) }}
                        <i ng-cloak
                            class="alert-count text-center @{{ inbox_count != '0' ? '' : 'fade' }}">@{{ inbox_count }}</i>
                    </span>
                    <!--  <i class="msg-icon">
    ...
    notifications-dropdown hide">
                ...
                <div class="panel drop-down-menu-msg hide js-become-a-host-dropdown">
                    <div class="trip-width">
                        <div class="panel-header no-border section-header-home"><strong><span>Messages</span></strong><a
                                href="{{ url('inbox') }}" class="link-reset view-trips pull-right"><strong><span>View
                                        Inbox</span></strong></a></div>

                        <div class="panel-header no-border section-header-home pull-left" style="width:100%;">
                            <strong><span>Notifications</span></strong><a href="{{ url('dashboard') }}"
                                class="link-reset view-trips pull-right"><strong><span>View
                                        Dashboard</span></strong></a>
                        </div>
                        <div class="pull-left" style="width:100%;padding:15px 20px;">

                            <p style="margin:0px;padding-top:10px !important;"> There are 3 notifications waiting for
                                you in your <a style="color:#333;text-decoration:underline;"
                                    href="{{ url('dashboard') }}"> {{ trans('messages.header.dashboard') }} </a>.</p>
        ...
        <ul class="nav pull-left list-unstyled" role="navigation">
            <li class="user-item pull-left medium-right-margin dropdown-trigger">
                <a class="link-reset header-avatar-trigger" id="header-avatar-trigger" href="{{ url('login') }}">
                    ...
                    <div class="media-photo media-round user-profile-image"
                        style="background: rgba(0, 0, 0, 0) url({{ Auth::user()->profile_picture->header_src }}) no-repeat scroll 0 0 / cover">
                    </div>
                ...
                <ul class="tooltip tooltip-top-right dropdown-menu list-unstyled header-dropdown drop-down-menu-login">
                    ...
                    <li class="reservations" style="display: none;">
                        <a href="{{ url('my_reservations') }}" rel="nofollow"
                            class="no-crawl link-reset menu-item item-reservation padding-left">
                            {{ trans('messages.header.your_reservations') }}
                        </a>
                    </li>
                    <li style="display: none;">
                        <a href="{{ url('trips/current') }}" rel="nofollow"
                            class="no-crawl link-reset menu-item item-trips padding-left">
                            {{ trans('messages.header.your_trips') }}
                        </a>
                    </li>
                    @if(Auth::user()->wishlists)
                    <li>
                        <a href="{{ url('wishlists/my') }}" id="wishlists"
                            class="no-crawl link-reset menu-item item-wishlists padding-left">
                            {{ trans_choice('messages.header.wishlist',2) }}
                        </a>
                    </li>
                    @endif
                    <li class="groups hide">
                        <a href="{{ url('groups') }}" rel="nofollow"
                            class="no-crawl link-reset menu-item item-groups padding-left">
      ...
      <a href="{{ url('invite') }}" class="no-crawl link-reset menu-item item-invite-friends padding-left">
        ...
        <span class="label label-pink label-new">
                    ...
                    <li>
                        <a href="{{ url('users/edit') }}" rel="nofollow"
                            class="no-crawl link-reset menu-item item-user-edit padding-left">
                            {{ trans('messages.header.edit_profile') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('account') }}" rel="nofollow"
                            class="no-crawl link-reset menu-item item-account padding-left">
                            {{ trans('messages.header.account') }}
                        </a>
                    </li>
                    <li class="business-travel hide">
                        <a href="{{ url('business') }}" rel="nofollow"
                            class="no-crawl link-reset menu-item item-business-travel padding-left">
                            {{ trans('messages.header.business_travel') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('logout') }}" rel="nofollow"
                            class="no-crawl link-reset menu-item header-logout padding-left">
                            {{ trans('messages.header.logout') }}
                        </a>
                    </li>
                </ul>
...
<div class="flash-container">
    ...
    @if((!Auth::check() || Route::current()->uri() == 'rooms/{id}' || Route::current()->uri() == 'payments/book/{id?}'
    || Route::current()->uri() == 's') )
        ...
        <div class="page-container-responsive page-container-auth margintop">
            ...
            Log In
                        ...
                        <div class="panel-body pad-25 bor-none padd1 ">
                            ...
                            <a href="{{ $fb_url }}"
                                class="fb-button fb-blue btn icon-btn btn-block btn-large row-space-1 btn-facebook font-normal pad-top">
                                <span><i class="icon icon-facebook"></i></span>
                                <span>{{ trans('messages.login.login_with')}} Facebook</span>
                            </a>

                            <a href="{{URL::to('googleLogin')}}"
                                class="btn icon-btn btn-block btn-large row-space-1 btn-google font-normal pad-top mr1">
               ...
               <a href="{{URL::to('auth/linkedin')}}" class="li-button li-blue btn icon-btn btn-block btn-large row-space-1 btn-linkedin mr1">
                  ...
                  <span >{{ trans('messages.login.login_with')}}  LinkedIn</span>
                            ...
                            <form method="POST" action="{{ url('authenticate') }}" accept-charset="UTF-8"
                                class="signup-form login-form ng-pristine ng-valid" data-action="Signin"
                                novalidate="true"><input name="_token" type="hidden">

                                <input id="from" name="from" type="hidden" value="email_login">

                                <div class="control-group row-space-2 field_ico">
                                    @if ($errors->has('login_email')) <p class="help-block">
                                        {{ $errors->first('login_email') }}</p> @endif
                                    <div class="pos_rel">
                                        <i class="icon-envelope"></i>
                                        <input
                                            class="{{ $errors->has('login_email') ? 'decorative-input inspectletIgnore invalid' : 'decorative-input inspectletIgnore name-icon' }}"
                                            placeholder="{{ trans('messages.login.email_address') }}" id="signin_email"
                                            name="login_email" type="email" value="">
                                    </div>
                                </div>

                                <div class="control-group row-space-3 field_ico">
                                    @if ($errors->has('login_password')) <p class="help-block">
                                        {{ $errors->first('login_password') }}</p> @endif
                                    <div class="pos_rel">
                                        <i class="icon-lock"></i>
                                        <input
                                            class="{{ $errors->has('login_password') ? 'decorative-input inspectletIgnore invalid' : 'decorative-input inspectletIgnore name-icon' }}"
                                            placeholder="{{ trans('messages.login.password') }}" id="signin_password"
                                            data-hook="signin_password" name="login_password" type="password" value="">
                                    </div>
                                </div>

                                <div class="clearfix row-space-3">
                                    <label for="remember_me2" class="checkbox remember-me">
                                        <input id="remember_me2" class="remember_me" name="remember_me" type="checkbox"
                                            value="1"> {{ trans('messages.login.remember_me')}}
                                    </label>
                                    <a href=""
                                        class="forgot-password forgot-password-popup link_color pull-right h5">{{ trans('messages.login.forgot_pwd')}}</a>
                                </div>

                                <input class="btn btn-primary btn-block btn-large pad-top btn_new" id="user-login-btn"
                                    type="submit" value="{{ trans('messages.header.login') }}">
                            </form>
                        </div>
          ...
          <img src="images/close.png">
                        ...
                        <div class="panel-padding panel-body pad-25 padd1">
                            ...
                            <div class="social-buttons">
                                <a href="{{ $fb_url }}"
                                    class="fb-button fb-blue btn icon-btn btn-block row-space-1 btn-large btn-facebook pad-23"
                                    data-populate_uri="" data-redirect_uri="{{URL::to('/')}}/authenticate">
                                    <span>
                                ...
                                <a href="{{URL::to('googleLogin')}}"
                                    class="btn icon-btn btn-block row-space-1 btn-large btn-google pad-23">
                                    <span>
                  ...
                  <span>
                    {{ trans('messages.login.signup_with') }} LinkedIn
                            ...
                            <div class="text-center social-links hide">
                                {{ trans('messages.login.signup_with') }} <a href="{{ $fb_url }}"
                                    class="facebook-link-in-signup">Facebook</a> {{ trans('messages.login.or') }} <a
                                    href="{{URL::to('googleLogin')}}">Google</a>
                            </div>
                            ...
                            <div class="text-center">
                                <a href=""
                                    class="create-using-email btn-block  row-space-2 btn btn-primary btn-block btn-large large icon-btn pad-23 signup_popup_head2 btn_new1"
                                    id="create_using_email_button">
                                    <span>
                            ...
                            <div id="tos_outside" class="row-space-top-3">
                                <small class="small-font style1">
                                    ...
                                    <a href="{{ url($company_page->url) }}" class="link_color"
                                        data-popup="true">,{{ $company_page->name }}</a>
                                    @endforeach
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="panel-body bottom-panel1 text-center">
                            <hr>
                            {{ trans('messages.login.already_an') }} {{ $site_name }}
                            {{ trans('messages.login.member') }}
                            <a href="{{ url('login') }}"
                                class="modal-link link-to-login-in-signup login-btn login_popup_head link_color"
                        ...
                        <div id="forgot_password_container" class="padd1">
                            ...
                            <div class="panel-padding row-space-3 ">
                                ...
                                <div id="inputEmail" class="textInput text-input-container field_ico">
                                    {!! Form::email('email', '', ['placeholder' => trans('messages.login.email'), 'id'
                                    => 'forgot_email', 'class' => $errors->has('email') ? 'decorative-input
                                    inspectletIgnore invalid input_new' : 'decorative-input inspectletIgnore
                                    input_new']) !!}
                                    <i class="icon-envelope"></i>
                                </div>
                            </div>
            ...
            <div class="log-ash-head">{{ trans('messages.header.signup') }}</div> -->
                        <div class="pad-25 panel-body pad-25 bor-none padd1 clearfix">
                            ...
                            <p class="text-center mr_non">Sign up with
                                ...
                                <a href="{{ $fb_url }}" data-populate_uri=""
                                    data-redirect_uri="{{URL::to('/')}}/authenticate" class="link_color"> Facebook</a>
                                or
              ...
              <a href="{{URL::to('auth/linkedin')}}" class="link_color">LinkedIn </a> -->
                            ...
                            {!! Form::open(['action' => 'UserController@create', 'class' => 'signup-form', 'data-action'
                            => 'Signup', 'id' => 'user_new', 'accept-charset' => 'UTF-8' , 'novalidate' => 'true']) !!}
                            <div class="signup-form-fields">
                                ...
                                <div class="control-group row-space-2 field_ico" id="inputFirst">
                                    ...
                                    <div class="pos_rel">
                                        ...
                                        {!! Form::text('first_name', '', ['class' => $errors->has('first_name') ?
                                        'decorative-input invalid ' : 'decorative-input name-icon input_new',
                                        'placeholder' => trans('messages.login.first_name')]) !!}
                                    </div>
                                </div>
                                <div class="control-group row-space-2 field_ico" id="inputLast">
                                    @if ($errors->has('last_name')) <p class="help-block">
                                        {{ $errors->first('last_name') }}</p> @endif
                                    <div class="pos_rel">
                                        <i class="icon-users"></i>
                                        {!! Form::text('last_name', '', ['class' => $errors->has('last_name') ?
                                        'decorative-input inspectletIgnore invalid' : 'decorative-input inspectletIgnore
                                        name-icon input_new', 'placeholder' => trans('messages.login.last_name')]) !!}
                                    </div>
                                </div>
                                <div class="control-group row-space-2 field_ico" id="inputEmail">
                                    ...
                                    <div class="pos_rel">
                                        <i class="icon-envelope"></i>
                                        {!! Form::email('email', '', ['class' => $errors->has('email') ?
                                        'decorative-input inspectletIgnore invalid' : 'decorative-input inspectletIgnore
                                        name-mail name-icon input_new', 'placeholder' =>
                                ...
                                <div class="control-group row-space-2 field_ico" id="inputPassword">
                                    ...
                                    <div class="pos_rel">
                                        <i class="icon-lock"></i>
                                        {!! Form::input('password','password',old('password'), ['class' =>
                                        $errors->has('password') ? 'decorative-input inspectletIgnore invalid' :
                                        'decorative-input inspectletIgnore name-pwd name-icon input_new', 'placeholder'
                                        => trans('messages.login.password'), 'id' => 'user_password', 'data-hook' =>
                                        'user_password']) !!}
                                ...
                                $errors->has('birthday_year')) <p class="help-block">
                                ...
                                <div class="control-group row-space-2 calander_new">
                                    <div class="select month drp_dwn_cng">
                                        ...
                                        'invalid' : '', 'id' => 'user_birthday_month']) !!}
                                    </div>
                            ...
                            {!! Form::submit( trans('messages.header.signup'), ['class' => 'btn btn-primary btn-block
                            btn-large pad-top' , 'id' => 'user-signup-btn', 'ng-disabled'=>'!checked']) !!}
                            {!! Form::close() !!}
                        </div>
                        <div class="panel-body bottom-panel1 text-center ">
                            <hr>
                            ...
                            {{ trans('messages.login.member') }}
                            <a href="{{ url('login') }}"
                                class="width-100 modal-link link-to-login-in-signup login-btn login_popup_head link_color "
                                data-modal-href="/login_modal?" data-modal-type="login">
                                {{ trans('messages.header.login') }}
                            </a>
                        </div>
