<style>
    @media (max-width: 760px) {
        .ggb-responsive-skype-email {
            margin-right: -5% !important;
        }

        .ggb-responsive-color{
    ...
    <header class="header--sm show-sm" aria-hidden="true" role="banner">
        ...
        <nav role="navigation" class="nav--sm">
            ...
            <div class="nav-content--sm panel text-white">
               ...
               <li class="{{ (Auth::user()) ? 'items-logged-out' : '' }}">
                                ...
                                <li class="{{ Auth::user() ? 'items-logged-out' : '' }}">
                                    <a rel="nofollow" class="link-reset menu-item "
                                        href="{{ url('/') }}/signup_login" data-signup-modal="">
         ...
         padding: 10px;"><svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                                ...
                                <li class="{{ Auth::user() ? '' : 'items-logged-in' }}">
                                    <a class="link-reset menu-item" rel="nofollow"
      ...
      padding: 10px;"><svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                                ...
                                @if (@Auth::user()->wishlists)
                                    <li class="{{ Auth::user() ? '' : 'items-logged-in' }}">
                                        <a href="{{ url('wishlists/my') }}" class="link-reset menu-item"
                                            rel="nofollow">
   ...
   <li class="{{ (Auth::user()) ? '' : 'items-logged-in' }}">
    ...
    <a class="link-reset menu-item" rel="nofollow" href="{{ url('/') }}/invite">
      {{ trans('messages.header.invite_friends') }}
                                ...
                                <li class="{{ Auth::user() ? '' : 'items-logged-in' }}">
                                    <a class="link-reset menu-item logout" rel="nofollow"
                                        href="{{ url('/') }}/logout">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="holecheck">
                                                                            <div class="___class_+?107___">
                                                                                ...
                                                                                @if ($row_room->id == 1)
                                                                                    <i
                                                                                        class="icon icon-entire-place h5 needsclick"></i>
                                                                                @endif
                                                                                @if ($row_room->id == 2)
                                                                                    <i
                                                                                        class="icon icon-private-room h5 needsclick"></i>
                                                                                @endif
                                                                                @if ($row_room->id == 3)
                                                                                    <i
                                                                                        class="icon icon-shared-room h5 needsclick"></i>
                                                                                @endif
                                                                                @if ($row_room->id >= 4)
                                                                                    <i
                        ...
                        <strong>{{ trans('messages.home.category') }}</strong>
                                ...
                                HostExperienceBladeCommentEnd --}}
                                    ...
                                    <div class="row row-space-top-2">
                                        <div class="col-sm-12">
                                            <button type="submit" id="search-form--sm-btn"
    ...
    <header style="height: 45px !important;background-color: #E5E5E5;">
        <div class="pull-right resp-zoom ggb-responsive-color">
            <ul class="nav pull-left help-menu list-unstyled">
                <li class="list-your-space pull-left ggb-responsive-skype-email">
    ...
    <span class="screen-reader-only">
      {{ $site_name }}
        ...
        <a aria-label="Homepage"
            style="background-image: url('http://honestrooms-qa.herokuapp.com/images/logos/sparerooms.png'); position: absolute;height: 150px !important;width: 300px !important;margin-top: -35px;z-index: 1;"
            href="{{ url('/') }}"
        ...
        <a id="my_element"  class="header-become-host become {{ Auth::check() ? '' : 'login_popup_open' }}"
            ...
            HostExperienceBladeCommentEnd --}}
                {{-- HostExperienceBladeUnCommentStart --}}
                 ...
                 <li class="list-your-space pull-left">
                     <a id="my_element" href="{{ url('/') }}/become_a_host" style="border-color: #24A4BA;color: #24A4BA;border-radius: 0.5em;border-left: 1px !important;" class="btn btn-outline-primary borderLeftLG" > 
...
<style>
            ...
            @if (!Auth::check())
                <ul class="nav pull-left logged-out list-unstyled">
                    <li id="sign_up" class="pull-left font-color">
                        <a data-signup-modal="" data-header-view="true" href="{{ url('signup_login') }}"
                            data-redirect="" class="link-reset signup_popup_head ">
                            {{ trans('messages.header.signup') }}
                        </a>
                    </li>
                    <li id="login" class="pull-left font-color">
                        <a data-login-modal="" href="{{ url('login') }}" data-redirect=""
                            class="link-reset login_popup_head">
                            {{ trans('messages.header.login') }}
                        </a>
                    </li>
                </ul>
                ...
                <ul class="nav pull-left list-unstyled msg-wish">
                    <li class="pull-left dropdown-trigger">
                        <a class="link-reset trip-drop" href="{{ url('trips/current') }}">
                            <span class="___class_+?144___"> {{ trans('messages.header.Trips') }}</span>
                            <!-- <i class="trips-icon">
        <i class="alert-count fade">0</i>
                        ...
                        <div class="panel drop-down-menu-trip hide js-become-a-host-dropdown">
                            <div class="trip-width">
                                <div class="panel-header no-border section-header-home">
                                    <strong><span>Trips</span></strong><a href="{{ url('trips/current') }}"
                    ...
                    <li id="inbox-item" class="inbox-item pull-left dropdown-trigger js-inbox-comp"
                        ...
                        <a href="{{ url('inbox') }}" rel="nofollow" class="no-crawl link-reset inbox-icon">
                            <span class="___class_+?163___" style="position:relative;">
                                {{ trans_choice('messages.dashboard.message', 2) }}
                                <i ng-cloak
    ...
    notifications-dropdown hide">
                        ...
                        <div class="panel drop-down-menu-msg hide js-become-a-host-dropdown">
                            <div class="trip-width">
                                <div class="panel-header no-border section-header-home">
                                    <strong><span>Messages</span></strong><a href="{{ url('inbox') }}"
                                        class="link-reset view-trips pull-right"><strong><span>View
                                                Inbox</span></strong></a>
                                </div>
                                ...
                                <div class="pull-left" style="width:100%;padding:15px 20px;">
                                    ...
                                    <p style="margin:0px;padding-top:10px !important;"> There are 3 notifications
                                        waiting for
                                        you in your <a style="color:#333;text-decoration:underline;"
                                            href="{{ url('dashboard') }}">
                                            {{ trans('messages.header.dashboard') }} </a>.</p>
                    ...
                    <li id="header-help-menu" class="help-menu-container pull-left dropdown-trigger">
                        <a class="link-reset" href="{{ url('help') }}">
                            <span class="___class_+?177___">{{ trans('messages.header.help') }}</span>
                            <!-- <i class="help-icon"></i>-->
                        </a>
                    </li>
                </ul>
                ...
                <ul class="nav pull-left list-unstyled" role="navigation">
                    <li class="user-item pull-left medium-right-margin dropdown-trigger">
                        <a class="link-reset header-avatar-trigger" id="header-avatar-trigger"
                            href="{{ url('login') }}">
                        ...
                        <ul
                            class="tooltip tooltip-top-right dropdown-menu list-unstyled header-dropdown drop-down-menu-login">
                            <li>
                                <a href="{{ url('dashboard') }}" rel="nofollow"
                                    class="no-crawl link-reset menu-item item-dashboard padding-left">
                                    {{ trans('messages.header.dashboard') }}
                            ...
                            <form method="POST" action="{{ url('authenticate') }}" accept-charset="UTF-8"
                                ...
                                <div class="control-group row-space-2 field_ico">
                                    @if ($errors->has('login_email'))
                                        <p class="help-block">
                                            {{ $errors->first('login_email') }}</p>
                                    @endif
                                    <div class="pos_rel">
                                        <i class="icon-envelope"></i>
                                        <input
                                            class="{{ $errors->has('login_email') ? 'decorative-input inspectletIgnore invalid' : 'decorative-input inspectletIgnore name-icon' }}"
                                            placeholder="{{ trans('messages.login.email_address') }}"
                                            id="signin_email" name="login_email" type="email" value="">
                                    </div>
                                </div>
                                ...
                                <div class="control-group row-space-3 field_ico">
                                    ...
                                    <div class="pos_rel">
                                        ...
                                        <input
                                            ...
                                            id="signin_password" data-hook="signin_password" name="login_password"
                                            type="password" value="">
                                    </div>
                                </div>
                                ...
                                <div class="clearfix row-space-3">
                                    <label for="remember_me2" class="checkbox remember-me">
                                        <input id="remember_me2" class="remember_me" name="remember_me"
                                            type="checkbox" value="1"> {{ trans('messages.login.remember_me') }}
                                    </label>
                                    <a href=""
                    ...
                    {{ trans('messages.login.signup_with') }} LinkedIn
                            ...
                            <div class="text-center social-links hide">
                                {{ trans('messages.login.signup_with') }} <a href="{{ $fb_url }}"
                                    class="facebook-link-in-signup">Facebook</a> {{ trans('messages.login.or') }}
                                <a href="{{ URL::to('googleLogin') }}">Google</a>
                            </div>
...
<div class="login-close">
    ...
    'class' => $errors->has('email')
        ? 'decorative-input
                                    inspectletIgnore invalid input_new'
        : 'decorative-input inspectletIgnore
                                    input_new',
]) !!}
                                    <i class="icon-envelope"></i>
                                </div>
                            ...
                            <div class="clearfix">
                                <a href="#" class="bck_btn"> <i class="icon-chevron-left"></i> Back to
                                    Login</a>
...
<img src="images/close.png">
                        ...
                        <div class="pad-25 panel-body pad-25 bor-none padd1 clearfix">
                            ...
                            <p class="text-center mr_non">Sign up with
                                ...
                                <a href="{{ $fb_url }}" data-populate_uri=""
                                    data-redirect_uri="{{ URL::to('/') }}/authenticate" class="link_color">
                                    Facebook</a>
                                or
                            ...
                            <div class="signup-form-fields">
                                ...
                                <div class="control-group row-space-2 field_ico" id="inputLast">
                                    ...
                                    <div class="pos_rel">
                                        <i class="icon-users"></i>
                                        {!! Form::text('last_name', '', [
    'class' => $errors->has('last_name')
        ? 'decorative-input inspectletIgnore invalid'
        : 'decorative-input inspectletIgnore
                                        name-icon input_new',
    'placeholder' => trans('messages.login.last_name'),
]) !!}
                                    </div>
                                </div>
    ...
    'placeholder' => trans('messages.login.email_address'),
                            ...
                            {!! Form::submit(trans('messages.header.signup'), [
