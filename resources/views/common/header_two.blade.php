...
<header class="regular-header clearfix hide-sm" id="old-header" role="banner" style="background: none !important;">
    ...
    <a aria-label="Homepage"
        style="background-image: url('http://honestrooms-qa.herokuapp.com/images/logos/sparerooms.png'); position: absolute;height: 150px !important;width: 300px !important;margin-top: -35px;"
        href="{{ url('/') }}"
