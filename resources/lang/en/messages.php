...
return [
	...
	'home' => [
		'title' => 'There’s a room waiting for you.',
		'desc' => 'Find a safe space: we verify every room.',
		'desc_2' => 'All private rooms for one month minimum stays.',
		...
		'step_1_title'         => 'Safe search and pick',
        'step_1_desc'          => 'Search your perfect room. We know the first step, before making any important decision, is to have information, and that is why we offer you detailed descriptions, both of properties and neighbourhoods. ',  
		'step_1_desc_A'        => 'Properties ckeck-out',
		'step_1_desc_A_desc'   => 'For your peace of mind, instead of using third-parties resources, we personally visit and take pictures of every room in the property. So that the day you move, you find no surprises. ',
		'step_1_desc_B'        => 'Your decision',
        'step_1_desc_B_desc'   => 'All rooms are private, and in case you prefer to share yours with somebody, it is possible but it is your decision. ',
		'step_2_title'         => 'Book your room online',
        'step_2_desc'          => 'Once you send your booking query, the owner will have 24 hours to confirm your request. Most commonly, both parties have questions between them, and this is why we offer the possibility to chat through our platform.', 
        'step_3_title'         => 'Confirmation and payment methods',
        'step_3_desc'          => 'As soon as the owner accepts your booking, you will be able to pay through Mercado Pago or PayPal and we will put you in touch with your host so as to coordinate moving schedules', 
		'step_3_desc_A'        => 'What are you paying for?',
        'step_3_desc_A_desc'   => 'Down payment includes a one-time Concierge Fee, corresponding to the customized follow up we offer and a proportional share of first month rent. ',
		'step_4_title'         => 'Get ready to move',
        'step_4_desc'          => 'The day has arrived!  You have a new home and your first day of your stay in this beautiful city is today. Your host will receive you and both will sign the online contract. The remaining payment of the month (as you already paid a proportional with your booking) and the deposit, will be paid to you host in cash.',   
		'step_4_desc_A'        => 'Month payment',
        'step_4_desc_A_desc'   => 'The first month payment will be in cash and will represent the difference between the proportional amount you paid with your booking and the total amount. Forward payments will not necessarily be done at the beginning of each month, because the date is fixed according to the day you checked in. If you check in on the 20th, you will pay on the 20ths, if you check in on the 1st, you will pay every 1st of each month.',
		'step_4_desc_B'        => 'Deposit',
		'step_4_desc_B_desc'   => 'The deposit is paid on the day you move and in cash. At the end of your stay, according to the contract, this deposit will be reimbursed to you If all conditions set up in the undersigned contract have been fulfilled. From this moment on, your host will be the contact point. Without any doubt, we will be there to help you both if you needed so.',
		'view_properties'      => 'VIEW PROPERTIES',
		'know_more' 	       => 'For more information',
		'why_choose_us'        => 'Why choose us',
		'our_differential'     => 'Our differential',
		'differential_1_title' => 'What you see is what you get',
        'differential_1_desc'  => 'You can trust the pictures we show you because we were responsible for taking them. Besides, all properties offered are personally checked by our professional staff. ',
        'differential_2_title' => '24 hour Guarantee. Reality Check.',
        'differential_2_desc'  => 'We want you to have the best of the experiences and that is why we check every room to ensure you that they look exactly how they appear in the pictures. If you arrive and within 24 hours notice that something does not match the pictures or descriptions that you saw and you no longer wish to stay in the room, don´t worry! Just let us know and we will refund your booking payment in full. Super easy. Zero risk for you because we take all the risks.',
        'differential_3_title' => 'A super positive impact from every angle',
        'differential_3_desc'  => 'The chance of renting an empty room is a sustainable, renewable, long-term income that helps our hosts to cover part of their expenses. That is why, when you rent a safe, verified room, you give elderly women opportunities to receive real incomes by renting you that extra room in their houses. ',
        'differential_4_title' => 'We act as intermediaries between you and your host.',
        'differential_4_desc'  => 'In case you have any trouble with your host, we will be there to help solve any conflict and avoid rough spots between cohabitants ',
		'testimonials'         => 'Testimonials',
		'testimonials_clients' => 'What our clients say',
		'press'                => 'Press',
		'what_the_media_say'   => 'What the media say',
		'read_more'            => 'READ MORE',
		'discover_places' => 'Discover Amazing Places',
		'steps_desc' => 'Find your room in 4 simple steps',
	...
	'your_reservations' => [
		...
		'flexible_checkin_time' => 'Flexible Move In time',
		'flexible_checkout_time' => 'Flexible Move Out time',
	...
	'lys' => [
		...
		'set_min_max_nights' => 'Set min and max months, gap days, and advance notice.',
		...
		'block_night' => 'Block :count month before and after each reservation',
		...
		'finish' => 'Finish',
		'pricing_title' => 'Set a Monthly Price for Your Space',
		'pricing_desc' => 'Set the monthly price for the room',
		'pricing_desc1' => 'This is one of the most complicated parts, we know it. It is important that it is a market price for your room to be rented. We can help you',
		...
		'November' => 'November',
		'December' => 'December',
		'price_each_night' => 'Price for each month',
		'Available' => 'Available',
		'Blocked' => 'Blocked',
		'add_note' => 'Add note',
		'Monday' => 'Mon',
		...
		'select_nights' => 'Select months',
		'percentage_of_discount' => 'Percentage of discount',
		'weekly' => 'Weekly',
		'monthly' => 'Monthly',
		'saved' => 'Saved',
		'no_of_days' => 'Number of nights',
		'add' => 'Add',
		'discount' => 'Discount',
		'period' => 'Period',
		'during' => 'During',
		...
		'service_title' => 'Service you offer to your guest',
		'service_desc1' => 'Room rental through Spare Rooms Buenos Aires includes cleaning and weekly change of sheets and towels.',
		'service_desc2' => 'Please click both options to advance with your notice.',
		'service_offer_to_guest'   => 'Services you offer to your guest',
		'weekly_cleaning_room'     => 'Weekly cleaning of the room',
		'bed_sheet_weekly_changed' => 'Bed sheets and towels (weekly changed)',
		'host_you'                 => 'Host (you)',
		'host_desc'                => 'Tell your guests about you',
		'rules_of_the_house'       => 'Rules of the house',
		'rules_desc'               => 'Can your guest smoke? Do you accept pets? Are visits allowed? You decide all this.',     
		'bathroom_desc'            => 'Do you offer the room with private bathroom or is it share with the other members of the house?',  
		'monthly_price' => 'Monthly Price',
		'monthly_price_desc' => 'You may want attract your first few guests by offering a great deal. You can always increase your price after you’ve received some great reviews', 
		'resubmit'           => 'Resubmit', 
		'services_offer'     => 'Service Type',
	...
	'rooms' => [
		...
		'night_after_guest' => 'month after the :count guest',
		'no_charge' => 'No Charge',
		'week' => 'week',
		'month' => 'month',
		...
		'Pre accepted' => 'Pre accepted',
		'avg_night_rate' => 'Average monthly rate is rounded',
		...
		'minimum_stay_error' => 'Minimum stay is :count months',
		'maximum_stay_error' => 'Maximum stay is :count months',
		],
	...
	'host_dashboard' => [
		...
		'title' => 'Guess, how many months you\'ve hosted this year\'?',
		'breakdown' => 'breakdown',
		...
		'invite_friends' => 'Invite friends',
		'for_nights_in_month' => 'for :count months in :month',
	...
	'cancellation_policy' => [
		...
		'our_cancellation_policy'	=>	'Our cancellation policy seeks to take care of the reservation commitment on the room, since you as an associate leave other requests aside once you accept a reservation.',
		'in_case_of_cancellation'	=>	'In case of cancellation, the returns vary according to the anticipation period. ',
		'if_after_confirming_a_reservation'	=>	'If after confirming a reservation and transferring the required reservation deposit a client gives at least 30 days notice of cancellation of the reservation before the scheduled check-in date a 100% refund of the transferred amount in the form of a reservation deposit will be returned to the client. ',
		'if_after_confirming_a_reservation_and_transferring_the_required'	=>	'If after confirming a reservation and transferring the required reservation deposit a client gives less than 29 days notice of cancellation of the reservation before the scheduled check-in date none of the transferred amount in the form of a reservation deposit will be returned to the client and will be used to cover damages and losses to the property owner as well as compensate for expenses and services provided by Spare Rooms Buenos Aires.',
		'we_will_send_you_the_value'	=>	'We will send you the value of the Rental Prepayment. ',
		'to_continue_you_need_to_accept'	=>	'To continue you need to accept (or not) this cancellation policy.',
		'remember_that_if_you'	=>	'Remember that if you don\'t accept our cancellation policies we can\'t upload your room in our web page.',
		'i_accept_the_cancellation'	=>	'I accept the Cancellation policy that holds Spare Rooms Buenos Aires.',
		'not_accept_the_cancellation'	=>	'I don\'t accept the Cancellation policy that holds Spare Rooms Buenos Aires.',
	...
	[ 
		'services'                => 'Services',
		'host'                    => 'Host',
		'who_lives_house'         => 'Who lives in the house?',
		'who_lives_house_desc'    => 'Tell the people who live in your house. Are there any pets? Children, grandchildren, couple?',
		'speak_language'          => 'What languages do you speak?',
		'others'                  => 'Others',
		'any_pets'                => 'Do you have any pets?',
		'no_pets'                 => 'I have no pets',
		'summary'                 => 'Summary',
		'rules'                   => 'Rules',
		'allow_to_smoke_home'     => 'Is it allowed to smoke at your home?',
		'accept_pets_from_guest'  => 'Do you accept pets from your guests?',
		'guest_invite_visitors'   => 'Can guests invite visitors?',
		'yes'                     => 'Yes',
		'no'                      => 'No',
		'bathroom'                => 'Bathroom',
		'rooms_private_house'     => 'Does the room has a private bathroom?',
		'rooms_shared_house'      => 'If it\'s a shared bathroom, With how many people it\'s shared?',
		'include_service'         => 'Which services are included in the rent?',
		'services_offer'          => 'Services Offer',
		'lives_house_desc'        => 'Lives in the house description',
		'lives_house'             => 'Lives in the house',
		'speak_languages'         => 'Speak Language',
		'pets_allowed'            => 'Pets Allowed',
		'nopets'                 => 'No Pets',
		'allow_smoke_at_home'     => 'Allow to Smoke at home',
		'smoke_not_allow_at_home' => 'Not Allow to Smoke at home',
		'accept_pet_from_guest'   => 'Accept Pets from guest',
		'pets_not_accept_from_guest' => 'Not Accept Pets from guest',
		'guests_invite_visitors'     => 'Allow Invite Visitors',
		'guests_not_invite_visitors' => 'Not Allow Invite Visitors',
		'bathrooms'                  => 'Bathrooms',
		'private_bathrooms'          => 'Private Bathrooms',
		'shared_bathrooms'           => 'Shared Bathrooms',
		'people_its_shared'          => 'People it\'s shared',
		'service'                    => 'Service',
		'per_month'                  => 'Per Month',
		'month'                      => 'Month|Months',
	...
	'new_rooms' => [
		...
		'number_month'              => 'No.of Month',
		'admin'                     => 'Admin',
		'resubmit_msg'              => 'Reason for Resubmission',
		'resubmit'                  => 'Resubmit',
		'resubmit_listing'          => 'Resubmit Listing',
		'close'                     => 'Close',
		'awaiting_admin_approval'   => 'You got New listing named as',
		'was_listed_on'             => 'was listed on',
		'awaiting_approval'         => 'The listing is Waiting for your approval to get listed.',
		'select_month'              => 'Select Month',
		'minimum_month'             => 'Minimum Month',
		'month'                     => 'Month | Months',
		'waiting_approval_for_listed' => 'Waiting for your approval to get listed.',
		'awaiting_approval_host'    => 'Your listing is waiting for admin to approve',
		'thanks_for_listing'        => 'Thanks for Listing in',
		'your_listing'              => 'Your listing',
		'your_listing_waiting_admin'=> 'will be get valued and get approved by the Admin soon',
		'rental_prepayment'         => 'Rental Prepayment',
		'one_time_service_fee'      => 'One time Service Fee',
		'payable_amount'            => 'Payable Amount',
		'remaining_amount_host'     => 'Remaining Payment directly pay to host',
		'collect_amount_guest'      => 'Collect Amount directly to guest',
		'paid_amount'               => 'Paid Amount',
		'rent_per_month'            => 'Rent Per Month',
		'total_to_pay_for_booking'  => 'Total to pay for booking',
		'payments_directly_to_host' => 'Payments that you must make directly to the host',
		'when_you_arrive'           => 'When you arrive',
		'monthly_rent'              => 'Monthly Rent',
		'security_deposit'          => 'Security Deposit',
		'during_your_stay'          => 'During Your Stay',
		'during_guest_stay'         => 'During guest Stay',
		'when_you_leave'            => 'When you Leave',
		'deposit_back_to_host'      => 'Deposit back to be returned by your host',
		'host_accept_booking_msg'   => 'Once the host accepts your booking, you will have to make the following payments to Spare Rooms Buenos Aires',
		'host_accept_booking_admin_msg'   => 'Once the host accepts guest booking, guest will have to make the following payments to Spare Rooms Buenos Aires',
		'when_guest_arrive'         => 'When guest arrive',
		'when_guest_leave'          => 'When guest Leave',
		'payments_collect_to_guest' => 'Guest will pay the below amounts directly to you when they arrive',
		'payments_collect_to_admin_guest' => 'Guest will pay the below amounts directly to host when they arrive',
		'day'                       => 'Night | Nights',
