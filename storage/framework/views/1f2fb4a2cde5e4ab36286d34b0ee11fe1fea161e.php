...
<ul class="menu-group list-unstyled row-space-3">
 ...
 <!--  <li  class="<?php echo e((Auth::user()) ? '' : 'items-logged-in'); ?>">
    <a class="link-reset menu-item" rel="nofollow" href="<?php echo e(url('/')); ?>/invite">
      <?php echo e(trans('messages.header.invite_friends')); ?>
                        ...
                        <div class="rom_ty" id="content-1">
                          ...
                          <div class="col-md-12 margin-top-10">
                            <div class="row">
                              <div class="holecheck">
                                <div class="">
                                  <input type="checkbox" value="<?php echo e(@$row_room->id); ?>" id="room-type-<?php echo e(@$row_room->id); ?>" class="mob_room_type" />
...
<header class="regular-header clearfix hide-sm" id="old-header" role="banner" style="background: none !important;">
  ...
  <div class="pull-right resp-zoom">
    <ul class="nav pull-left help-menu list-unstyled">
      ...
      <li id="header-help-menu" class="help-menu-container pull-left dropdown-trigger">
        <a class="help-toggle link-reset font-color" href="<?php echo e(url('help')); ?>">
          <?php echo e(trans('messages.header.help')); ?>
    ...
    <ul class="nav pull-left list-unstyled msg-wish">
      <li class="pull-left dropdown-trigger">
        <a class="link-reset trip-drop" href="<?php echo e(url('trips/current')); ?>">
          <span class=""> <?php echo e(trans('messages.header.Trips')); ?></span>
   <!-- <i class="trips-icon">
  ...
  <!--  <i class="msg-icon">
          ...
          <?php echo e(trans('messages.header.inbox')); ?>
...
<li id="header-help-menu" class="help-menu-container pull-left dropdown-trigger">
  <a class="link-reset" href="<?php echo e(url('help')); ?>">
    <span class=""><?php echo e(trans('messages.header.help')); ?></span>
    <!-- <i class="help-icon"></i>-->
  </a>
</li>
</ul>
...
<div class="flash-container">
  ...
  <?php if((!Auth::check() || Route::current()->uri() == 'rooms/{id}' || Route::current()->uri() == 'payments/book/{id?}' || Route::current()->uri() == 's') ): ?>
