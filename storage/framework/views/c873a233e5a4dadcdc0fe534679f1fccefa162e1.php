            ...
            <div class="lazy-load-div1 lazy-load1 col-md-12 col-lg-12 col-sm-12 col-xs-12  p-0" id="lazy_load_slider">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="reservation.length > 0">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 newsl"
                        ...
                        <h3 class="rowHeader pull-left"> react-text: 38121 <?php echo e(trans('messages.header.justbooked')); ?>
                                ...
                                <div class="panel-body panel-card-section">
                                    <div class="media">
                                        <div class="category_city hm_cate">
                                            ...
                                            <span class="pull-left">{{ fetch_data.rooms.beds }}
                                                {{ fetch_data.rooms.bed_lang }}</span>
                                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="recommented.length >0">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 newsl "
                        style="padding:0px;     margin: 45px 0px 15px;">
                        <h3 class="rowHeader pull-left"> react-text: 38121 <?php echo e(trans('messages.header.recommend')); ?>

                            /react-text </h3>
                        <div class="seeMoreContainer_11b8zgn pull-right">


                            <a href="<?php echo e(url('s')); ?>" ng-if="recommented.length > 3"><button
                                    class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">

                                    <span class="text_13lu1ne">
                                        <span><?php echo e(trans('messages.header.seeall')); ?></span></span>
                                ...
                                <div class="panel-body panel-card-section">
                                    <div class="media">
                                        <div class="category_city hm_cate">
                                            ...
                                            <span class="pull-left dot-cont">·</span>
                                            <span class="pull-left">{{ reservation.beds }}
                                                {{ reservation.bed_lang }}</span>
                                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 our-community p-0">
                    <div class="row">
                        <div class="discovery-section explore_community page-container-responsive page-container-no-padding"
                            style="padding:0px;">
                            <div class="col-lg-12 nopad text-center" style="padding: 0;"
                                ng-if="our_community.length!=0">
                                    ...
                                    <div class="por_ab">
                                        ...
                                        <div class="com-sub">
                                            ...
                                            <p class="over-head" style="width:90% !important;"
                                                ng-bind-html="our_community.description"></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
