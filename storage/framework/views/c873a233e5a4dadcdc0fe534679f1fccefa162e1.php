    ...
    <div class="whole-section sect_home" ng-controller="home_owl" ng-cloak>
        <div class="page-container-responsive new-page-container mini-rel-top row-space-top-1">
            <div class="panel">
                <div id="discovery-container" class="pad-sm-20"
                    style="float:left;width:100%;/* height: 100% !important; */background-image: url('http://honestrooms.herokuapp.com/images/home/home_two.jpg');height: 600px;width: 1500px;position: relative;margin-left: -170px;padding-right: 100px; padding-left: 20%;background-repeat: no-repeat;">
                            ...
                            <div
                                ...
                                <h1 class="textHeader_8yxs9w" style="color:white !important;">
                                    <span class="textHeaderTitle_153t78d-o_O-textHeader_rausch_hp6jb4"
                                        ...
                                        <!--<?php echo e($site_name); ?>--> There is a room that awaits you.
                                    </span>
                                    <!-- react-text: 7341 -->
                                    <br>
                                    <div style="font-size:30px">
                                        <?php echo e(trans('messages.home.desc')); ?>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 hide-sm">
                        <div class="container_e4p5a8">
                            <!-- react-empty: 18439 -->
                            <form action="<?php echo e(url('s')); ?>" class="simple-search" method="get" id="searchbar-form"
                                name="simple-search">
                                <div class="container_1tvwao0" style="width: 80% !important;">
                                    <div class="container_mv0xzc" style="width: 100%;background-color:white">
                                        <div class="label_1om3jpt"><?php echo e(trans('messages.header.where')); ?></div>
                                                ...
                                                <div>
                                                    <div class="container_e296pg">
                                                        <div class="container_36rlri-o_O-block_r99te6">
                                                            <label
                                                                class="label_hidden_1m8bb6v"><?php echo e(trans('messages.header.where')); ?></label>
                                                            <div
                                                                ...
                                                                <div class="inputContainer_178faes">
                                                                    <input autocomplete="off"
                                                                        ...
                                                                        placeholder="<?php echo e(trans('messages.header.anywhere')); ?>"
                                                                        value="" type="text">
                                                                </div>
                                                            </div>
                                                        </div>
                      ...
                      <div class="label_1om3jpt"><?php echo e(trans('messages.header.when')); ?></div>
                          ...
                          <div class="DateRangePickerDiv">
                            <div>
                              <div class="DateRangePickerInput">
                                <div class="DateInput">
                                  <input aria-label="Check In" class="DateInput__input needsclick" id="checkin" name="checkin" value="" placeholder="<?php echo e(trans('messages.header.checkin')); ?>" autocomplete="off" aria-describedby="DateInput__screen-reader-message-startDate" type="text">
                                  <div class="DateInput__display-text"><?php echo e(trans('messages.header.checkin')); ?></div>
                                </div>
                                <div class="DateRangePickerInput__arrow" aria-hidden="true" role="presentation">-
                                </div>
                                <div class="DateInput">
                                  <input aria-label="Check Out" class="DateInput__input needsclick" id="checkout" name="checkout" value="" placeholder="<?php echo e(trans('messages.header.checkout')); ?>" autocomplete="off" aria-describedby="DateInput__screen-reader-message-endDate" type="text"><div class="DateInput__display-text"><?php echo e(trans('messages.header.checkout')); ?></div>
                                </div>
                        ...
                        <div class="dateRangePicker_e296pg-o_O-hidden_ajz5vs">
                          ...
                          <div class="container_mv0xzc" style="width: 130px;border-right: 1px solid #e4e4e4;">
                            <div class="search_month">
                              <div class="label_1om3jpt col-md-12 padding_left"> <?php echo e(trans_choice('messages.new_rooms.month',1)); ?> </div>
                              ...
                              <div class="label_1om3jpt col-md-12 padding_left"> <?php echo e(trans('messages.header.guest')); ?> </div>
                                        ...
                                        <div class="save_search">
                                            ...
                                            <div class="container_mv0xzc save_but_block"
                                                ...
                                                <!-- /react-text --><button type="submit"
                                                    ...
                                                    <span><?php echo e(trans('messages.home.search')); ?></span>
                                                </button>
                            ...
                            <div data-id="SearchBarSmall" class="container_1tvwao0">
                                <div class="container_mv0xzc" style="width: 100%;">
                                    ...
                                    <button type="button" class="button_1b5aaxl button-sm-search">
                                        ...
                                        <span class="copy_14aozyc"><?php echo e(trans('messages.header.anywhere')); ?> ·
                                            <?php echo e(trans('messages.header.anytime')); ?> · 1
                                            <?php echo e(trans('messages.header.guest')); ?></span></button>
                                    <div class="focusUnderline_7131v4"></div>
                                </div>
                        ...
                        <div class="body_1sn4o6s-o_O-body_dropdown_7xdft6 arrow-button">
                            <button type="button"
                                ...
                                <span class="copy_14aozyc">
                                    <span><?php echo e(trans('messages.header.anywhere')); ?></span></span>
                            </button>
                            <div style="margin-top: 16px; margin-bottom: 16px;">
                                <button type="button"
                                    ...
                                    <span class="copy_14aozyc"><?php echo e(trans('messages.header.anytime')); ?></span>
                                </button>
                            </div>
                            <button type="button"
                                class="button_1b5aaxl-o_O-button_border_hu7ym7-o_O-button_large_c3pob4">
                                ...
                                <span class="copy_14aozyc"><span><span>1
                                            <?php echo e(trans('messages.header.guest')); ?></span></span></span>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <!--
                  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                     <ul class="home-menu">
                       <li><a class="foryou current" href="<?php echo e(url('/')); ?>"><?php echo e(trans('messages.header.for_you')); ?></a></li>
                       <li><a class="homes" href="<?php echo e(url('/s?current_refinement=Homes')); ?>"><?php echo e(trans('messages.header.homes')); ?> </a></li>
                 ...
                 <div class="lazy-load-div1 lazy-load1 col-md-12 col-lg-12 col-sm-12 col-xs-12  p-0" id="lazy_load_slider">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="reservation.length > 0">
                      <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 newsl" style="padding:0px;     margin: 45px 0px 15px;">
                       <h3 class="rowHeader pull-left"> react-text: 38121  <?php echo e(trans('messages.header.justbooked')); ?> /react-text </h3>
                       <div class="seeMoreContainer_11b8zgn pull-right">

                        <a href="<?php echo e(url('s')); ?>" ng-if="reservation.length > 3">
                         <button class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">
                           <span class="text_13lu1ne"><span><?php echo e(trans('messages.header.seeall')); ?></span></span>
            ...
            <!--
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="recommented.length >0">
                  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 newsl " style="padding:0px;     margin: 45px 0px 15px;">
                    <h3 class="rowHeader pull-left"> react-text: 38121 <?php echo e(trans('messages.header.recommend')); ?> /react-text </h3>
                     <div class="seeMoreContainer_11b8zgn pull-right">


                      <a href="<?php echo e(url('s')); ?>" ng-if="recommented.length > 3"><button class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">
      ...
      <div class="lazy-load-div1 lazy-load1 col-md-12 col-lg-12 col-sm-12 col-xs-12  p-0" id="lazy_load_slider">
          ...
          <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="most_viewed.length > 0">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 newsl" style="padding:0px;     margin: 45px 0px 15px;">
              <h3 class="rowHeader pull-left">< react-text: 38121<?php echo e(trans('messages.header.most_viewed')); ?> /react-text </h3>
              <div class="seeMoreContainer_11b8zgn pull-right">

                <a href="<?php echo e(url('s')); ?>" ng-if="most_viewed.length > 3">
                  <button class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">
                    <span class="text_13lu1ne"><span><?php echo e(trans('messages.header.seeall')); ?></span> </span>
                    <svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false" style="fill: currentcolor; height: 10px; width: 10px;"><path fill-rule="evenodd" d="M4.293 1.707A1 1 0 1 1 5.708.293l7.995 8a1 1 0 0 1 0 1.414l-7.995 8a1 1 0 1 1-1.415-1.414L11.583 9l-7.29-7.293z"></path></svg>
                  </button>
                ...
                <div class="panel-body panel-card-section">
                  <div class="media">
                    ...
                    <div class="exp_price">
                      ...
                      <?php echo e(trans("messages.rooms.per_month")); ?>
            ...
            <div class="discovery-section explore_community exploer_banner page-container-no-padding"
                ...
                <div class="section-intro text-center row-space-6 row-space-top-8" ng-if="home_city_explore.length!=0">
                    <h2 class="row-space-1">
                        <!-- <strong><?php echo e(trans('messages.home.explore_world')); ?></strong>-->
                        <strong>How does it work?</strong>
                    </h2>
                    <p class="text-lead">
                        <?php echo e(trans('messages.home.explore_desc')); ?>
                            ...
                            <div style="float:left;width:25%;text-align:center">
                                ...
                                <div style="padding-left:5%;padding-right:5%">
                                    <p class="content-font" style="margin-left: 10%;margin-right: 10%;">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam voluptatem rerum
                                        asperiores earum, maiores impedit accusamus nemo provident saepe laborum nisi
                            ...
                            <div style="float:left;width:25%;text-align:center">
                                ...
                                <div style="padding-left:5%;padding-right:5%">
                                    <p class="content-font" style="margin-left: 10%;margin-right: 10%;">
                                        ...
                                        veritatis ipsam ut ducimus a laborum qui, voluptate quisquam quae asperiores,
                            ...
                            <div style="float:left;width:25%;text-align:center">
                                ...
                                <div style="padding-left:5%;padding-right:5%">
                                    <p class="content-font" style="margin-left: 10%;margin-right: 10%;">
                                        ...
                                        voluptate vel odit quasi repellendus fugiat modi? Corporis a quaerat itaque est
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="most_viewed.length > 0">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 newsl"
                        ...
                        <h3 class="rowHeader pull-left">
                            < react-text: 38121<?php echo e(trans('messages.header.most_viewed')); ?> /react-text </h3>
                                <div class="seeMoreContainer_11b8zgn pull-right">

                                    <a href="<?php echo e(url('s')); ?>" ng-if="most_viewed.length > 3">
                                        <button class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">
                                            <span
                                                class="text_13lu1ne"><span><?php echo e(trans('messages.header.seeall')); ?></span>
                                            </span>
      ...
      <div class="row">
        <div class="discovery-section explore_community page-container-responsive page-container-no-padding" style="padding:0px;">
          <div class="col-lg-12 nopad text-center" style="padding: 0;" ng-if="our_community.length!=0">
              ...
              <strong>
                <?php echo e(trans('messages.home.our_community')); ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12" style="background:#ffffff;">
                <div class="col-md-4 columnn-foot">
                    <div class="columnContentContainer">
                        <div class="iconContainer">
                            <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                                style="display:block;fill:currentColor;height:33px;width:33px;" data-reactid="431">
                                <path fill-rule="evenodd"
                        ...
                        <div class="textContainer">
                            ...
                            <div><span class="content-font">If you need help while traveling or hosting, contact us
                                    at our toll free number: <?php echo e($customer_support); ?></span></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 columnn-foot" style="">
                    <div class="columnContentContainer">
                        <div class="iconContainer">
                            <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                                style="display:block;fill:currentColor;height:33px;width:33px;" data-reactid="441">
                                <path
                                    ...
                                    fill-rule="evenodd" data-reactid="442" />
                            </svg>
                        </div>
                        <div class="textContainer">
                            ...
                            <div>
                                <span class="content-font">
                                    ...
                                    <!-- /react-text -->
                                    <span>
                                        <a href="<?php echo e(url('host_guarantee')); ?>" target="_blank">
                                            <!-- react-text: 452 --><?php echo e(trans('messages.search.learn_more')); ?>
                ...
                <div class="col-md-4 columnn-foot">
                    <div class="columnContentContainer">
                        <div class="iconContainer">
                            <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                                style="display:block;fill:currentColor;height:33px;width:33px;" data-reactid="455">
                                <path
                                    ...
                                    fill-rule="evenodd" data-reactid="456" />
                            </svg>
                        </div>
                        <div class="textContainer">
                            <div class="columnHeader"><span>Verified ID</span></div>
                            <div><span class="content-font">We aim to build a trusted community by giving you more
                                    info when you're deciding who to host or stay with.</span></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('template_two', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>